                    ...
                    <div class="swiper-slide py-5">
                        <div class="row banner-content align-items-center">
                            ...
                            <div class="content-wrapper col-md-7 p-5 mb-5">
                                ...
                                <h2 class="banner-title display-1 fw-normal">Gấu Bông<span class="text-primary">Cao Cấp</span>
                                </h2>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="d-flex flex-wrap mt-3">
                                            <a href="chitietsanpham.php?id=<?= $value['IDSanPham'] ?>" class="btn-cart me-3 px-4 pt-3 pb-3">
