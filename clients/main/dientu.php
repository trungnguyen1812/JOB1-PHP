...
include_once '../../controller/giohang.php'; // Include Giohang controller
include_once '../../controller/khachhang.php'; // Include KhachHang controller if not already included
...
?>
        ...
        ?>
            <script>
                ...
                window.location.href = 'dientu.php'; // Reload page to update cart
            </script>
<?php
            exit();
        }
    ...
    // Handle registration (if you have a registration form)
                    ...
                    <div class="swiper-slide py-5">
                        <div class="row banner-content align-items-center">
                            <div class="img-wrapper col-md-5">
                                <img style="mix-blend-mode: multiply;" width="700" height="750" src="../images/banner/gundamjpg.jpg" class="img-fluid">
                            </div>
                            <div class="content-wrapper col-md-7 p-5 mb-5">
                                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                                <h2 class="banner-title display-1 fw-normal">Đồ Chơi<span class="text-primary">Điện Tử</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="foodies" class="my-5">
        <div class="container my-5 py-5">
            <div class="section-header d-md-flex justify-content-between align-items-center">
                ...
                <div class="mb-L4 mb-md-0"></div>
                <div>
                    <a href="dientu.php" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
                        Mua Ngay
            ...
            <div class="isotope-container row">
                <?php
                $sanphamListHotTrend = $sanpham->showProductsByCategory(7);
                ?>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <form action="dientu.php" method="POST">
