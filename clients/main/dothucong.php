                    ...
                    <div class="swiper-slide py-5">
                        <div class="row banner-content align-items-center">
                            <div class="img-wrapper col-md-5">
                                <img width="700" height="750" src="../images/banner/DoThuCongjpg.jpg" class="img-fluid">
                            </div>
                            <div class="content-wrapper col-md-7 p-5 mb-5">
                                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                                <h2 class="banner-title display-1 fw-normal">Đồ Chơi<span class="text-primary">Thủ Công</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="foodies" class="my-5">
        <div class="container my-5 py-5">
            <div class="section-header d-md-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="dothucong.php" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
                        Mua Ngay
            ...
            <div class="isotope-container row">
                <?php
                $sanphamListHotTrend = $sanpham->showProductsByCategory(10); // Category ID 10 for Đồ Thủ Công
                ?>
                <?php if (!empty($sanphamListHotTrend)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>Không có sản phẩm đồ thủ công.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>
